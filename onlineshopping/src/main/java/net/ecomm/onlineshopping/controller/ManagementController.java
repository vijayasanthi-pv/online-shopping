...
import net.ecomm.onlineshopping.util.FileUploadUtility;
import net.ecomm.onlineshopping.validator.ProductValidator;
...
public class ManagementController {
	...
	public String handleProductSubmission(@Valid @ModelAttribute("product") Product mProduct, BindingResult results, Model model,
		...
		//logger.info("id :: "+mProduct.getId()+" "+mProduct.getDescription());
		if (mProduct.getId() == 0) {
